...
export const faq = { // faq section
    ...
    costOfLivingPrograms: 'Advanced JavaScript/Node and React and Fullstack Day Bootcamp programs', // leave as empty string is cost of living availability is the same across all programs
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Choose between the Fullstack Day Bootcamp, Fullstack Evening Bootcamp, and Advanced Javascript/Node and React programs."
    },
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKPDXAJ17",
    ...
    },
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKPDXD17",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 26000,
            loanTerm36: true,
            loanTerm60: true,
    ...
    },
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKPDXDEV17",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 16500,
            loanTerm36: true,
            loanTerm60: true,
